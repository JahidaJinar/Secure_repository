/**
 * EdTech Secure Project Repository - Firebase SDK & Auth Initialization
 */
...
// Local storage session mock provider for instant offline execution without external API dependencies
const AppAuth = {
  getCurrentUser() {
